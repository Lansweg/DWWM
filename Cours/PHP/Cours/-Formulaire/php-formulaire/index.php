...
<body>
	...
	<div class="container">
		...
		<br>
		<div class="card">
			<div class="card-header" style="text-align: center;font-size: 25px;">Votre site <b><?=$_SERVER['SERVER_NAME'];?></b> est <b>fonctionnel</b> ! <i class="fa fa-check" aria-hidden="true"></i></div>
		...
		<div class="card">
			<div class="card-body">
				<center>Copyright 2018-<?=date('Y');?> © <a href="https://webstrator.com">WebStrator.com</a> est un service édité par <a href="https://octogency.fr">OctoGency SAS</a></center>
			</div>
		</div>
	</div>
